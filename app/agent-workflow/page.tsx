            ...
            <div className="mx-auto max-w-7xl space-y-6">
                    ...
                    <div className="flex flex-wrap items-start justify-between gap-4">
                        <div>
                            ...
                            <p className="mt-2 max-w-3xl text-sm text-slate-400">
                                Safe workflow board for planning agent execution before real AI file changes.
                            </p>
                        </div>
                ...
                <section className="rounded-3xl border border-white/10 bg-white/[0.04] p-6">
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="mt-4 rounded-2xl bg-emerald-600 px-5 py-3 text-sm font-bold hover:bg-emerald-500 disabled:opacity-50"
                    >
                        Start Safe Workflow
                    </button>
                </section>
                ...
                <section className="grid gap-4 md:grid-cols-3">
                    ...
                    <div className="rounded-2xl border border-white/10 bg-white/[0.04] p-5">
                        ...
                        <p className="mt-2 text-sm font-bold text-slate-100">
                            {workflow?.updated_at || "Not loaded"}
                        </p>
                    </div>
                </section>
                ...
                <section className="rounded-3xl border border-white/10 bg-white/[0.04] p-6">
                    ...
                    <p className="mt-3 text-sm leading-6 text-slate-300">
                        {workflow?.user_request || "No request yet."}
                    </p>
                </section>
